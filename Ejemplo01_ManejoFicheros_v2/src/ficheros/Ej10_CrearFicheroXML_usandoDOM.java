...
public class Ej10_CrearFicheroXML_usandoDOM {
  public static void main(String argv[]) throws IOException{
   File fichero = new File(".\\src\\Ficheros\\Prueba\\AleatorioAlumno.dat");   
   ...
   try{
     ...
     Result result = new StreamResult(new java.io.File(".\\src\\Ficheros\\Prueba\\Alumnos.xml"));  // Nombre del fichero XML      
